                                ...
                                if(!preg_match("/^[a-zA-Z0-9.,:\/<> -\"]*$/", $notelp)){
                                    ...
                                    if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $alamat)){
                                        ...
                                        if(!preg_match("/^[a-zA-Z., ]*$/", $kepala)){
                                            $_SESSION['kepala'] = 'Form Nama Pimpinan hanya boleh mengandung karakter huruf, spasi, titik(.) dan koma(,)<br/><br/>';
                                            echo '<script language="javascript">window.history.back();</script>';
                                        } else {
                            ...
                            <form class="col s12" method="post" action="?page=sett" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input id="notelp" type="text" class="validate" name="notelp" value='<?php echo $row['notelp']; ?>' required>
                                            <?php
                                                if(isset($_SESSION['notelp'])){
                                                    $notelp = $_SESSION['notelp'];
                                                    echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$notelp.'</div>';
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input id="kepala" type="text" class="validate" name="kepala" value="<?php echo $row['kepala']; ?>" required>
                                            ...
                                            ?>
                                        <label for="kepala">Nama Pimpinan</label>
                                    </div>
                                    <div class="input-field col s6">
