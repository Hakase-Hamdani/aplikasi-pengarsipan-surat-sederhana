            ...
            $pg = @$_GET['pg'];
                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <div class="col m7">
                                        <ul class="left">
                                            <li class="waves-effect waves-light hide-on-small-only"><a href="?page=ref" class="judul"><i class="material-icons">class</i> Divisi</a></li>';
                ...
                $cari = mysqli_real_escape_string($config, $_REQUEST['cari']);
                    ...
                    <div class="col m12" id="colres">
                        ...
                        $query = mysqli_query($config, "SELECT * FROM tbl_divisi");
