...
--
-- Host: localhost
-- Generation Time: Nov 19, 2024 at 03:30 AM
...
INSERT INTO `tbl_staf` (`id_staff`, `id_user`, `id_instansi`, `nama`, `NIP`) VALUES
(1, 1, NULL, 'Muhammad Hamdani', '2110010302');
...
--
ALTER TABLE `tbl_klasifikasi`
  ADD CONSTRAINT `tbl_klasifikasi_ibfk_1` FOREIGN KEY (`id_instansi`) REFERENCES `tbl_instansi` (`id_instansi`);

--
-- Constraints for table `tbl_staf`
--
ALTER TABLE `tbl_staf`
  ADD CONSTRAINT `tbl_staf_ibfk_1` FOREIGN KEY (`id_instansi`) REFERENCES `tbl_instansi` (`id_instansi`),
