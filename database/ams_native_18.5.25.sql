...
--
-- Host: localhost
-- Generation Time: May 18, 2025 at 09:25 AM
...
(102, 'Bidang Keuangan', 'Testing teknisk disposisi', 'Penting', '2025-02-20', '--', 101, 1),
(103, 'Divisi IT', 'Teknis Tambahan Divisi', 'Biasa', '2025-02-20', '--', 101, 1);
...
(101, 484, 'asdd', 'Me', 'TEST', 'AX.zw-M44', 'CAD-3764', 'x123-123', '2025-02-05', '2025-02-20', '9891-7e4b5ce2.jpg', '--', 4),
(102, 485, '2025-01-KK', 'Kota Banjarmasin', 'Testing', 'AX.zw-M44', NULL, '100-090', '2025-02-20', '2025-02-20', '9217-2025-02-2009.30.396944889856280893790.jpg', '--', 4);
...
--
ALTER TABLE `tbl_disposisi`
  MODIFY `id_disposisi` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;
...
--
ALTER TABLE `tbl_surat_masuk`
  MODIFY `id_surat` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;
