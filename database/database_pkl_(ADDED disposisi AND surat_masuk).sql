...
--
-- Host: localhost
-- Generation Time: Jan 03, 2025 at 04:04 PM
...
(6, 1, 'Dummy', 'HK.01.01', 105, 'test', 'tesr', 'test', '2024-12-02', '2025-01-01 13:11:28', '2926-Irfan Islamy TTD.pdf', NULL),
(9, 1, 'Dummy', 'HK.01.00', 106, 'Dummy', 'Dummy2', 'Dummy', '2025-01-25', '2025-01-01 16:46:09', NULL, '--');
...
--
ALTER TABLE `tbl_disposisi`
  ADD CONSTRAINT `tbl_disposisi_ibfk_1` FOREIGN KEY (`id_staf`) REFERENCES `tbl_staf` (`id_staff`),
...
--
ALTER TABLE `tbl_staf`
  ADD CONSTRAINT `tbl_staf_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `tbl_user` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;
